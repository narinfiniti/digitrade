...
public sealed class ProcessRuntimeOutboxMessageEntityTypeConfiguration : IEntityTypeConfiguration<ProcessRuntimeOutboxMessage>
{
    public void Configure(EntityTypeBuilder<ProcessRuntimeOutboxMessage> builder)
    {
        ArgumentNullException.ThrowIfNull(builder);

        builder.ToTable("outbox_messages");

        builder.Ignore(message => message.CreatedAt);
