...
public static class QueryableExtensions
{
    ...
    /// </summary>
    public static IQueryable<T> PageBy<T>([MaybeNull] this IQueryable<T> query, int skipCount, int maxResultCount)
    {
    ...
    /// Used for paging. Can be used as an alternative to Skip(...).Take(...) chaining.
    /// </summary>
    public static TQueryable PageBy<T, TQueryable>([MaybeNull] this TQueryable query, int skipCount, int maxResultCount)
