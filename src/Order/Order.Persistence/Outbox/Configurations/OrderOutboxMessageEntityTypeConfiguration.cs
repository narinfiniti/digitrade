...
namespace Order.Persistence.Outbox.Configurations;

public sealed class OrderOutboxMessageEntityTypeConfiguration : IEntityTypeConfiguration<OrderOutboxMessageEntity>
{
    public void Configure(EntityTypeBuilder<OrderOutboxMessageEntity> builder)
    {
