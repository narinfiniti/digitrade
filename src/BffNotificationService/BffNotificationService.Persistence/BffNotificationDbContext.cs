...
public sealed class BffNotificationDbContext(DbContextOptions<BffNotificationDbContext> options) : DbContext(options)
{
    public const string DefaultSchema = "bffnotification";
